...
## Corpus Check
- 26 files · ~211,703 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 8 file(s) not represented in the graph (top: (none) 5, .rules 1, .webmanifest 1)

## Summary
- 121 nodes · 163 edges · 17 communities (14 shown, 3 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.93)
...
## Knowledge Gaps
- **48 isolated node(s):** `DEFAULT_USER`, `CATEGORY_ORDER`, `CATEGORY_KEYWORDS`, `SUGGESTIONS`, `customSuggestions` (+43 more)
